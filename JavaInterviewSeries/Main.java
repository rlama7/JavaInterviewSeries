...
import com.ratnalama.arrayChunk.ArrayChunk;
import com.ratnalama.fizzbuzz.FizzBuzz;
import com.ratnalama.maxChars.MaxChars;
import com.ratnalama.maxLen.MaxLen;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArrayChunk ac = new ArrayChunk();
        MaxLen mxl = new MaxLen();
        System.out.println("---------------------------------------------------------------");
...
//        System.out.println();
        ...
        // Max Length: frequency of number in an Array
        System.out.println("---MaxLen---");
        int[] array = new int[]{1,1,1,2,2,3,3,3,3,3,3,4,4,4,6,6,6,7,7,8,9};
        int maxLen = mxl.maxLen(array);
        System.out.println("The frequency of number in Array is: " + maxLen);
